...
import parseQueryString from 'shitty-qs'
...
/**
 * @param {import('./types').IApiClientOptions} opts
 * @constructor
 */
function ApiClient(opts) {
  assertOptions(opts)

  this.request = rateLimit(axios.create(_.defaultsDeep(opts.axiosOptions || {}, axiosDefaultOptions)), opts.rateLimitOptions || rateLimitDefaultOptions)
